...
template <class TypeGuess> int construct_guess_AES (TypeGuess ***guess, Matrix *m, uint32_t n_m, uint32_t bytenum, uint32_t R, uint32_t * sbox, uint32_t n_keys, int8_t bit, bool ttable_idx);
